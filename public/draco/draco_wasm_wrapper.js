...
$jscomp.polyfillIsolated = function (k, n, l, p) {
	...
	n = n(l);
	null != n &&
		(k ? $jscomp.defineProperty($jscomp.polyfills, h, { configurable: !0, writable: !0, value: n }) : n !== l &&
...
var DracoDecoderModule = function () {
	...
	return function (n) {
		...
		var Xa = Object.assign({}, a),
			...
			Ya = 'object' == typeof process && 'object' == typeof process.versions &&
		...
		(function () {
			...
			(function () {
				return fa || 'function' != typeof WebAssembly.instantiateStreaming ||
						P.startsWith('data:application/octet-stream;base64,') || P.startsWith('file://') || Ya ||
		...
		var bb = a._emscripten_bind_VoidPtr___destroy___0 = function () {
			...
			Ha = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = function () {
				return (Ha = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = a.asm.E)
			...
			Ka = a._emscripten_bind_Mesh_Mesh_0 = function () {
				return (Ka =
					a._emscripten_bind_Mesh_Mesh_0 =
			...
			Fb = a._emscripten_bind_Mesh___destroy___0 = function () {
				return (Fb =
					a._emscripten_bind_Mesh___destroy___0 =
						a.asm.W).apply(null, arguments);
			},
			...
			Ac = a._emscripten_bind_Decoder_GetAttributeFloat_3 = function () {
				return (Ac =
					a._emscripten_bind_Decoder_GetAttributeFloat_3 =
			...
			dd = a._emscripten_enum_draco_DataType_DT_UINT8 = function () {
				return (dd =
					a._emscripten_enum_draco_DataType_DT_UINT8 =
			...
			od = a._emscripten_enum_draco_StatusCode_OK = function () {
				return (od =
					a._emscripten_enum_draco_StatusCode_OK =
						a.asm.Nb).apply(null, arguments);
			},
